# JEV_TaqMan3NTR_FLI Script for NCBI download 
...
while (length(r_search$ids) < 2) {
  r_search <- entrez_search(db="nucleotide", 
                          # term="1000:12000[SLEN] AND Japanese encephalitis virus[PORG]",
                          term="10000:12000[SLEN] AND Japanese encephalitis virus[PORG]",
                          retmax = 99999999,
                          use_history = T) 
}
